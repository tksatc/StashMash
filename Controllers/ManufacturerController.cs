...
namespace StashMash.Controllers
{
    public class ManufacturerController : Controller
    {
        ...
        public ManufacturerController(StashMashContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ManufacturerId,Name,Url")] Manufacturer manufacturer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ManufacturerId,Name,Url")] Manufacturer manufacturer)
        {
